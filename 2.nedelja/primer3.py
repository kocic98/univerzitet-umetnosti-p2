...
pit=Pitanje("Koliko različitih vremenskih zona ima na zemlji?",
            "36", "12", "48", "24", "4")

pitanja.append(pit)
pit=Pitanje("Koje je ime najčešće na svetu?",
            "Abdul", "Muhamed", "Wong", "Petar", "2")
pitanja.append(pit)

pitanja.append(Pitanje(pitanje="Koje je godine prvi put održano svetsko prvenstvo u fudbalu u Meksiku?",
                       odgovor1="1962.",
                       odgovor3="1986.",
                       odgovor2="1970.",
                       odgovor4="1982.",
...
pitanja.append(Pitanje("Koju zajedničku boju imaju zastave Andore, Belgije, Bosne i Hercegovine i Litvanije?",
               "Crvena", "Crna", "Žuta", "Plava", "3"))
pitanja.append(Pitanje("Kako se naziva gubitak sposobnosti čitanja?",
...
print(f"\nUkupno imate {brojTacnihOdgovora} tačnih odgovora")
